setTimeout(function(){
  $(function () {
      ...
      $('body').on('click', '.products-toggle', function (e) {
        ...
        $('#navbar-main-menu').toggleClass('desktop-menu-toggle')
      })
      ...
      $('body').on('click', '#mobile-menu-products', function (e) {
          e.preventDefault();
          $('body').addClass('mobile-products-nav-active')
      })


      $('body').on('click', '#mobile-menu-about', function (e) {
          e.preventDefault();
          $('body').addClass('mobile-about-nav-active')
      })

      $('body').on('click', '#mobile-menu-legal', function (e) {
          e.preventDefault();
          $('body').addClass('mobile-legal-nav-active')
      })
